...
assert(mocSw.includes("exopace-moc-v14"), "MOC SW cache bumped");
...
assert(radSw.includes("exopace-radio-v14"), "Radio SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=14"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=14"), "index cache-busts hashed MOC bundle");
