...
assert(radSw.includes("exopace-radio-v21"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=21") && radioHtml.includes("env.js?v=21"), "Radio index cache-busts in-place JS");
