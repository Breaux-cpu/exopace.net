...
assert(radSw.includes("exopace-radio-v30"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=30") && radioHtml.includes("env.js?v=30"), "Radio index cache-busts in-place JS");
