...
assert(radSw.includes("exopace-radio-v58"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=58") && radioHtml.includes("env.js?v=58"), "Radio index cache-busts in-place JS");
