...
assert(radSw.includes("exopace-radio-v35"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=35") && radioHtml.includes("env.js?v=35"), "Radio index cache-busts in-place JS");
