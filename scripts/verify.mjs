...
assert(mocSw.includes("exopace-moc-v31"), "MOC SW cache bumped");
...
assert(radSw.includes("exopace-radio-v42"), "Radio SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=31"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=31"), "index cache-busts hashed MOC bundle");
...
assert(radioHtml.includes("app.js?v=42") && radioHtml.includes("env.js?v=42"), "Radio index cache-busts in-place JS");
