...
assert(mocSw.includes("exopace-moc-v59"), "MOC SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=59"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=59"), "index cache-busts hashed MOC bundle");
...
assert(index.includes("function syncPassCountdowns") && index.includes(".station .passlist .pt") && index.includes("passTargetByEl"), "NEXT PASSES AOS/LOS countdowns derive from the header sim instant under HOLD");
assert(index.includes("function fmtPassRemain") && index.includes("function passKind"), "pass countdown overlay re-anchors on AOS/LOS flips");
