...
assert(mocSw.includes("exopace-moc-v28"), "MOC SW cache bumped");
...
assert(radSw.includes("exopace-radio-v40"), "Radio SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=28"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=28"), "index cache-busts hashed MOC bundle");
...
assert(radioHtml.includes("app.js?v=40") && radioHtml.includes("env.js?v=40"), "Radio index cache-busts in-place JS");
