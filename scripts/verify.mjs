...
assert(radSw.includes("exopace-radio-v36"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=36") && radioHtml.includes("env.js?v=36"), "Radio index cache-busts in-place JS");
