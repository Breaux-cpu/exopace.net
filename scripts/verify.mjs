...
assert(mocSw.includes("exopace-moc-v18"), "MOC SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=18"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=18"), "index cache-busts hashed MOC bundle");
