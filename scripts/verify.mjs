...
assert(radSw.includes("exopace-radio-v49"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=49") && radioHtml.includes("env.js?v=49"), "Radio index cache-busts in-place JS");
