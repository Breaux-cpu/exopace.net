...
assert(radSw.includes("exopace-radio-v27"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=27") && radioHtml.includes("env.js?v=27"), "Radio index cache-busts in-place JS");
