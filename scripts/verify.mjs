...
assert(radSw.includes("exopace-radio-v52"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=52") && radioHtml.includes("env.js?v=52"), "Radio index cache-busts in-place JS");
