...
assert(radSw.includes("exopace-radio-v48"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=48") && radioHtml.includes("env.js?v=48"), "Radio index cache-busts in-place JS");
