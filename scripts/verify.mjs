...
assert(mocSw.includes("exopace-moc-v27"), "MOC SW cache bumped");
...
assert(radSw.includes("exopace-radio-v39"), "Radio SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=27"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=27"), "index cache-busts hashed MOC bundle");
...
assert(radioHtml.includes("app.js?v=39") && radioHtml.includes("env.js?v=39"), "Radio index cache-busts in-place JS");
