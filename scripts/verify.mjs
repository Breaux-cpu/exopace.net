...
assert(mocSw.includes("exopace-moc-v21"), "MOC SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=21"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=21"), "index cache-busts hashed MOC bundle");
