...
assert(radSw.includes("exopace-radio-v54"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=54") && radioHtml.includes("env.js?v=54"), "Radio index cache-busts in-place JS");
