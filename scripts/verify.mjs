...
assert(radSw.includes("exopace-radio-v50"), "Radio SW cache bumped");
...
assert(radioHtml.includes("app.js?v=50") && radioHtml.includes("env.js?v=50"), "Radio index cache-busts in-place JS");
