...
assert(mocSw.includes("exopace-moc-v52"), "MOC SW cache bumped");
...
assert(read("index.html").includes("moc-phone.css?v=52"), "index cache-busts moc-phone.css");
assert(read("index.html").includes("index-B5yAHF7-.js?v=52"), "index cache-busts hashed MOC bundle");
...
assert(index.includes('id="exo-toast"') && index.includes('showHudToast("NO LOCK")') && index.includes('SAT-CAM'), "SAT-CAM without a lock uses the same NO LOCK refusal as FOLLOW");
